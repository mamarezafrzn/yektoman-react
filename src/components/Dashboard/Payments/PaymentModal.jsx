...
const PaymentModal = (props) => {
  ...
  return (
    <form className={styles.newForm} onSubmit={onFormSubmit}>
        ...
        >
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="fund"
            >
              <MenuItem value={props.title.title}>{props.title.title}</MenuItem>
            </Select>
          </FormControl>
        </Box>
      </label>
      ...
      <label>
        مبلغ
        <input type="text" value={price.value .toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} onChange={onPriceChange} />
      </label>
      <label>
        کد رهگیری
        <input
