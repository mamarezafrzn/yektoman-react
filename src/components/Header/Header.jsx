    ...
    <div className="uxhaven-nav">
        <div className="container">
            <nav className="navbar navbar-expand-md navbar-light">
                <a className="navbar-brand" href=""><img src={logo} width="100" height="100" alt="logo"/></a>

                <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul className="navbar-nav nav">
                        <li className="nav-item"><a href="#home-section" className="nav-link active">خانه</a></li>
                        <li className="nav-item"><a href="#features-section" className="nav-link">ویژگیها</a></li>
                        <li className="nav-item"><a href="#about-section" className="nav-link">درباره ما</a></li>
                        <li className="nav-item"><a href="#plan-section" className="nav-link">اشتراک ها</a></li>
                        <li className="nav-item"><a href="#blog-section" className="nav-link">اخبار</a></li>
                        <li className="nav-item"><a href="#contact-section" className="nav-link">ارتباط با ما</a></li>
...
{/*                        </li>*/}
                ...
                <div className="others-options">
                    <nav className="navbar navbar-expand-md navbar-light text-text-info">
                        ...
                        <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul className="navbar-nav nav">
                                                <li className="nav-item"><a href="index.html#" className="nav-link">
                                                        <span className="icon-phone_android"></span>
                                                        تماس با پشتیبانی
                                                    </a>
                                                    <ul className="dropdown-menu">
                                                        <li className="nav-item"><a href="case-studies.html" className="nav-link">
                                                                <span className="text-primary">
                                            <p className="text-center">   از ۸ صبح تا ۱۰ شب</p>
                                            <p className="text-center">۷ روز هفته</p>
                                            <p className="text-center rtl" onclick="location.href ='tel:+989120242742'">
